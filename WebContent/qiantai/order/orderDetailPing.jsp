...
<html>
  ...
  <form action="<%=path%>/orderPing.action" method="post">
     <table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#F7F3F7">
		  ...
		  <tr class="text" align="center" bgcolor="#FFFFFF">
			  ...
			  <td><img src="<%=path %><s:property value="#orderItem.goods.goodsPic"/>" width="50px" height="50px"/>
			     
			  </td>
			  
			  <td><textarea name="txt<s:property value="#orderItem.orderItemId"/>" cols="25" rows="5"></textarea>
			      <input type="hidden" name="goods<s:property value="#orderItem.orderItemId"/>" value="<s:property value="#orderItem.goods.goodsId"/>"/>
			      <input type="hidden" name="goodsname<s:property value="#orderItem.orderItemId"/>" value="<s:property value="#orderItem.goods.goodsName"/>"/></td>
		  </tr>
		  </s:iterator>
		   <tr height="26">
